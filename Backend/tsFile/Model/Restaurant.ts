...
export function addWaiterToARestaurant(waiter : Waiter.Waiter, restaurant : Restaurant){
    restaurant.waiters.push(waiter.getId()); 
}

export function addCashierToARestaurant(user : Cashier.Cashier, restaurant : Restaurant){
    restaurant.cashiers.push(user._id); 
}

export function addBartenderToARestaurant(user : Bartender.Bartender, restaurant : Restaurant){
    restaurant.bartenders.push(user._id); 
}

export function addTableToARestaurant(table : Table.Table, restaurant : Restaurant){
